...
const Globe: React.FC<{
  ...
  return (
    <group ref={groupRef}>
      ...
      {/* Add some "dots" or points for a more tech feel if needed, 
          but keeping the provided logic as base */}
    </group>
  );
};
...
>(({
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "relative w-full min-h-screen bg-bg-dark overflow-hidden flex flex-col",
        className
      )}
      {...props}
    >
