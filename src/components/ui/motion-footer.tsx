...
@keyframes footer-heartbeat {
  0%, 100% { transform: scale(1); filter: drop-shadow(0 0 5px color-mix(in oklch, var(--color-primary) 50%, transparent)); }
  15%, 45% { transform: scale(1.2); filter: drop-shadow(0 0 10px color-mix(in oklch, var(--color-primary) 80%, transparent)); }
...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Inventory Redefined</span> <span className="text-primary/60">✦</span>
    <span>Digital Tracking</span> <span className="text-primary/60">✦</span>
    <span>Wholesale Operations</span> <span className="text-primary/60">✦</span>
    <span>Trader Connection</span> <span className="text-primary/60">✦</span>
    <span>Absolute Accuracy</span> <span className="text-primary/60">✦</span>
  </div>
);
      ...
      */}
      ...
      >
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-bg text-text cinematic-footer-wrapper">
          ...
          <div className="absolute top-[18vh] left-0 w-full overflow-hidden border-y border-white/5 bg-bg/60 backdrop-blur-md py-4 z-10 -rotate-2 scale-110 shadow-2xl">
